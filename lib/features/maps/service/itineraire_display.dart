...
class _RouteEventState extends State<RouteEvent> {
  final String _apiKey = '5b3ce3597851110001cf6248465d6b0ae5b34c62881034d3a7aada1b';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['features'] != null && data['features'].isNotEmpty) {
          ...
          setState(() {
            _routePoints = route.map<LatLng>((coord) => LatLng(coord[1], coord[0])).toList();
          });
        } else {
        ...
        print('Failed to fetch route: ${response.statusCode} - ${response.reasonPhrase}');
